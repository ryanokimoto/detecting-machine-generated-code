# %%
# Sets up environment, imports libraries, and disables WANDB logging
import os
...
# Wrapper class to handle data loading, model initialization, training, and evaluation
class CodeBERTTrainer:
    ...
    # Initializes the CodeBERT model and tokenizer for the specific number of labels
...
OUT_CSV = "codebert_submission.csv"
